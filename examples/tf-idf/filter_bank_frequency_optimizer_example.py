...
from news_classification.tfidf import Bow_Frequency_Optimizer, bow_filter, token_filter
...
if __name__ == '__main__':
    ...
    write_path = os.path.join('data', 'processing', 'tf-idf', 'filter_bank_optimizer',
                              '24NepaliNews', 'test_frequency_optimizer.pkl')
    ...
    optimizer_model = Bow_Frequency_Optimizer(filtered_BoW, labels)
    ...
    optimizer_model.calculate_bow_frequency(write_path)
